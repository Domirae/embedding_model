...
def processing():
    ...
    print(all_test_texts[0])

    total_reviews_docs = data_processing('/home/ailsb/PycharmProjects/test/data/total', total_reviews)
    ...
    return tokenizer_obj, vocab_size2, max_length , x_train_pad,train_targets,x_test_pad,test_targets
