...
from makeGloveEm import GloveEM
...
if __name__ == '__main__':
    ...
    glove = GloveEM(max_length,vocab_size,embedding_dim)
    ...
    embedding = glove.Convert2Vec(tokenizer)
    ...
    model.save('/home/ailsb/PycharmProjects/test/glove_dir/data/sentimental_model_glove.h5')
